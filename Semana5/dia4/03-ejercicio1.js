...
/**
 * Iterando el arreglo de películas, llenar la tabla
 * con los datos solicitados para cada película
 * HINT: en cada iteración, crear elementos TD, TR, etc etc etc
 */
...
peliculas.forEach((peli, i) => {
  ...
  tdNro.innerText = i + 1;
  tdId.innerText = peli.id;
  tdNombre.innerText = peli.title;
  tdAnio.innerText = peli.release_date;
  tdIdioma.innerText = peli.original_language;
